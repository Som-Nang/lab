...
<template>
    <div class="my-1 group">
        <!-- <div class="relative h-0 group-hover:block my-4 bg-red-500">
            <svg
                v-if="isActive"
        ...
        <div
            :class="{
                'bg-gray-200 dark:bg-slate-800 text-primary dark:text-white font-bold':
                    isActive,
            }"
        ...
        <!-- <div class="relative h-0 group-hover:block my-4 bg-red-500">
            <svg
                v-if="isActive"
                class="absolute top-0 right-0 hidden w-4 h-4 text-gray-200 rotate-90 dark:text-slate-800 md:block"
                xmlns="http://www.w3.org/2000/svg"
                width="259.51"
                height="259.52"
                viewBox="0 0 259.51 259.52"
